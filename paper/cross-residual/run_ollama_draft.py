...
out=ROOT/'paper/cross-residual/results/ollama_draft_v2.jsonl'; out.parent.mkdir(parents=True,exist_ok=True)
...
for pdf in pdfs:
    ...
    try:
        r=requests.post('http://127.0.0.1:11434/api/generate',json={'model':'qwen3:14b','prompt':prompt_tpl.format(txt),'stream':False,'options':{'temperature':0.1,'num_predict':2000}},timeout=300)
