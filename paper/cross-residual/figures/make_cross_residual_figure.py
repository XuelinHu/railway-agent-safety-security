...
box(.3,1.8,2.0,1.0,"Token\nrepresentations","#e6f2f8")
box(3.0,3.1,2.3,1.0,"Local encoder\nbranch","#d9ead3")
box(3.0,.5,2.3,1.0,"Graph/context\nbranch","#fce5cd")
box(6.2,1.8,2.2,1.0,"Cross-residual\nfusion","#cfe2f3")
box(9.2,1.8,2.0,1.0,"Span + relation\nheads","#eadcf8")
box(12.0,1.8,1.6,1.0,"Evidence-linked\noutputs","#fff2cc")
def arr(a,b,style='-'):
...
arr((4.1,3.1),(7.2,2.8),'--'); ax.text(5.45,3.35,'residual gate',ha='center',va='bottom',fontsize=8)
ax.text(7.2,.12,'Solid arrows: forward path; dashed arrow: cross-branch residual shortcut',ha='center',fontsize=8)
